...
public class DrawingProjectDemo extends JFrame {
   ...
   //Constructor of Class
    public DrawingProjectDemo() {
        setTitle("Simple Drawing App Demo");
        ...
        thicknessSlider = new JSlider(JSlider.HORIZONTAL, 0, 25, currentThickness);
        thicknessSlider.setMajorTickSpacing(5);
        thicknessSlider.setMinorTickSpacing(0);
    ...
    private void updateStatus() {
        ...
        statusLabel.setText(" Mode: " + mode + " | Color: ["
        ...
        public DrawingPanel() {
            MouseAdapter mouseAdapter = new MouseAdapter() {
               ...
               public void mousePressed(MouseEvent e) {
                    ...
                    showPopup(e); // if i pressed left click
                }
    ...
    private class ShapeInfo {
        ...
        public ShapeInfo(int type, Color color, int x1, int y1, int x2, int y2, int thickness) { // constractor of ShapeInfo
            this.type = type;
            this.color = color;
            this.x1 = x1;
            this.x2 = x2;
